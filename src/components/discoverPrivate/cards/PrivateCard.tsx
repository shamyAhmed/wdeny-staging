            ...
            <>
              <Swiper
                ...
                pagination={{
                  ...
                  clickable: false,
                  bulletClass:
                    "swiper-pagination-bullet !w-2 !h-2 !bg-white !opacity-60 !rounded-full",
                  bulletActiveClass:
                    "swiper-pagination-bullet-active !w-2 !h-2 !opacity-100 !rounded-full",
                }}
              ...
              <div
                className={`priv-dots-${id} absolute !left-1/2 !bottom-2 -translate-x-1/2 z-10 flex items-center justify-center gap-1.5`}
              />
              ...
              <button
                ...
                <FaArrowLeft
                  size={11}
                  className="text-gray-600 ltr:rotate-180"
                />
              </button>
            ...
            <div className="flex flex-col gap-2">
              <Button
                ...
                onClick={() => {
                  ...
                  const forward = ["trip_type", "date", "time", "return_date", "return_time"];
                  forward.forEach((key) => {
